...
public class CompileSourceInMemory {
	static String outputFolder = "D:/jad";

	public static void executeJavaCode(String javaCode, String className,
		...
		if (success) {
			try {
				URLClassLoader classLoader = URLClassLoader.newInstance(
						new URL[] { new File(outputFolder).toURI().toURL() },
						urlClassLoader);
				Class.forName(className, true, classLoader)
						.getDeclaredMethod("test",
								new Class[] { WebDriver.class })
						.invoke(null, new Object[] { driver });
